...
//    @SuppressWarnings("unchecked")
    ...
    private void AuthenticateAndLogin() throws SQLException, IOException {
        ...
        if (!NhanVienDAO1.getInstance().Login(txtUsername.getText(), txtPassword.getText())) {
            txtmessage.setText("Sai tên đăng nhập hoặc mật khẩu!!");
            return;
        }

        NhanVienDAO1 nvdao = new NhanVienDAO1();
        String name = nvdao.getTenNVById(txtUsername.getText());
        NhanVien.name = name;
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            try {
                ...
                Logger.getLogger(MenuDangNhap.class.getName()).log(Level.SEVERE, null, ex);
            }
