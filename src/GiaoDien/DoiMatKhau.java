...
public class DoiMatKhau extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!txtPassOld.getText().equals(NhanVienDAO1.getInstance().GetAccount().getPassword())) {
        ...
        if (NhanVienDAO1.getInstance().DoiMatKhau(NhanVienDAO1.getInstance().GetAccount().getId(), txtPassNew.getText())) {
