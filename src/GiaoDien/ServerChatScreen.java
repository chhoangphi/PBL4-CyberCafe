...
public class ServerChatScreen extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServerChatScreen frame = new ServerChatScreen();
    ...
    private void SendIt() {
        ...
        try {
            ...
            client.SendMessage(NhanVien.name + "-" + message);
     ...
     */
    public ServerChatScreen() throws UnknownHostException, IOException {

        textArea = new JTextArea();

        client = new Client(textArea);
        setTitle(NhanVien.name);
        setResizable(false);
